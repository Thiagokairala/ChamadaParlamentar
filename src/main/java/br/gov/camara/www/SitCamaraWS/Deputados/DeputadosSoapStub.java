...
public class DeputadosSoapStub extends org.apache.axis.client.Stub implements br.gov.camara.www.SitCamaraWS.Deputados.DeputadosSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("ObterDetalhesDeputados");
        ...
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", ">>ObterDetalhesDeputadosResponse>ObterDetalhesDeputadosResult"));
        oper.setReturnClass(br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadosResponseObterDetalhesDeputadosResult.class);
        oper.setReturnQName(new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", "ObterDetalhesDeputadosResult"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[3] = oper;
    ...
    public DeputadosSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", ">>ObterDetalhesDeputadosResponse>ObterDetalhesDeputadosResult");
            cachedSerQNames.add(qName);
            cls = br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadosResponseObterDetalhesDeputadosResult.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
            ...
            qName = new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", ">ObterDetalhesDeputados");
            cachedSerQNames.add(qName);
            cls = br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputados.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);

            qName = new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", ">ObterDetalhesDeputadosResponse");
            cachedSerQNames.add(qName);
            cls = br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadosResponse.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {idBloco, numLegislatura});
  ...
  throw axisFaultException;
    ...
    public br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadosResponseObterDetalhesDeputadosResult obterDetalhesDeputados(java.lang.String ideCadastro, java.lang.String numLegislatura) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI("http://www.camara.gov.br/SitCamaraWS/Deputados/ObterDetalhesDeputados");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://www.camara.gov.br/SitCamaraWS/Deputados", "ObterDetalhesDeputados"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {ideCadastro, numLegislatura});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadosResponseObterDetalhesDeputadosResult) _resp;
            } catch (java.lang.Exception _exception) {
                return (br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadosResponseObterDetalhesDeputadosResult) org.apache.axis.utils.JavaUtils.convert(_resp, br.gov.camara.www.SitCamaraWS.Deputados.ObterDetalhesDeputadosResponseObterDetalhesDeputadosResult.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
